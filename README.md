...
- A visible context meter is in the 75 to 85 percent warning range, or no meter is visible but practical risk signals show the thread is already context-heavy.
